...
START_TEST(test_vunit10)
{
   set_standard(STD_93);

   input_from_file(TESTDIR "/parse/vunit10.vhd");
...
START_TEST(test_issue961)
{
   input_from_file(TESTDIR "/parse/issue961.vhd");
